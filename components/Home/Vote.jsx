        ...
        <div className="row gy-10 gy-xxl-0 justify-content-center justify-content-xxl-between align-items-center">
          <div className="col-lg-6 col-xxl-5">
            <div className="trade_on__content">
              ...
              Donate Through Democrochain
              </span>
              <h3 className="mb-4 mb-lg-5">WHY TO Donate THROUGH OUR DAPP</h3>
              <p className="fs-six mx-ch">
              Donating in our blockchain DApp ensures transparency, security, and fairness in the Donation process. By leveraging blockchain technology, we provide a tamper-proof system where every Donate is securely recorded and easily verifiable. Empower yourself and contribute to a more trustworthy Donation system by casting your Donating in our innovative DApp.
              </p>
          ...
          <div className="col-md-8 col-lg-6">
            <div className="trade_on__thumbs d-flex justify-content-end">
              <img src="assets/images/trade_don.png" alt="Imgae" />
            </div>
          </div>
        </div>
      </div>
